...
def test_add_pets_with_valid_data(name='Bil', animal_type='monkey', age='8', pet_photo='images/Bil.jpg'):
...
def test_delete_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pets(api_key, 'Bil', 'monkey', '8', 'images/Bil.jpg')
        _, my_pets = pf.get_list_of_pets(api_key, 'my_pets')
...
def test_update_pet_info(name='из', animal_type='измененный', age='6'):
    ...
    def test_add_pets_with_valid_data_without_photo(name='ПетБезФото', animal_type='Бибизян', age='7'):
...
def test_add_photo_at_pet(pet_photo='images/Bob.jpg'):
...
def test_add_pet_negative_age_number(name='Bil', animal_type='monkey', age='-8', pet_photo='images/Bil.jpg'):
...
def test_add_pet_with_four_digit_age_number(name='Bil', animal_type='monkey', age='9988', pet_photo='images/Bil.jpg'):
...
def test_add_pet_with_empty_value_in_variable_name(name='', animal_type='monkey', age='8', pet_photo='images/Bil.jpg'):
...
def test_add_pet_with_a_lot_of_words_in_variable_name(animal_type='monkey', age='8', pet_photo='images/Bil.jpg'):
    ...
    name = 'Bil Fortunate viae meae beatae manus me successus manet Amen'
...
def test_add_pet_with_special_characters_in_variable_animal_type(name='Bil', age='8', pet_photo='images/Bil.jpg'):
...
def test_add_pet_with_numbers_in_variable_animal_type(name='Bil', animal_type='55777', age='6',
                                                      pet_photo='images/Bil.jpg'):
...
def test_add_pet_with_a_lot_of_words_in_variable_animal_type(name='Bil', age='9', pet_photo='images/Bil.jpg'):
    ...
    animal_type = 'Ксолоитцкуинтли Койкерхондье Као де кастро-лаборейро Аппенцеллер зенненхунд Энтлебухер Глен оф Имаал терьер '
